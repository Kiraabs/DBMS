namespace DBMS.ClassLibrary.Other
{
    public static class UserMSG
    {
        ...
        public static (DialogResult Dr, bool Empty) WarnIfTextEmpty(string msg, string text, string hdr = "Warning") => WarnIfTrue(msg, string.IsNullOrWhiteSpace(text), hdr);
        ...
        {
            if (string.IsNullOrWhiteSpace(msg) || string.IsNullOrWhiteSpace(hdr))
